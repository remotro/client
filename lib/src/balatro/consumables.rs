...
impl Translatable for TarotKind {
    fn translate(&self, translations: &Translations) -> Translation {
        ...
        match self {
            ...
            TarotKind::Magician => render!(translations, path, 2, "Lucky Card").unwrap(),
            TarotKind::HighPriestess => render!(translations, path, 2).unwrap(),
            TarotKind::Empress => render!(translations, path, 2, "Mult Card").unwrap(),
            TarotKind::Emperor => render!(translations, path, 2).unwrap(),
            TarotKind::Heirophant => render!(translations, path, 2, "Bonus Card").unwrap(),
            TarotKind::Lovers => render!(translations, path, 1, "Wild Card").unwrap(),
            TarotKind::Chariot => render!(translations, path, 1, "Steel Card").unwrap(),
            TarotKind::Justice => render!(translations, path, 1, "Glass Card").unwrap(),
            TarotKind::Hermit => render!(translations, path, 20).unwrap(),
            TarotKind::WheelOfFortune { probability } => render!(translations, path, *probability, 4).unwrap(),
            TarotKind::Strength => render!(translations, path, 2).unwrap(),
            TarotKind::HangedMan => render!(translations, path, 2).unwrap(),
            TarotKind::Death => render!(translations, path, 2).unwrap(),
            TarotKind::Temperance { earnings } => render!(translations, path, 50, *earnings).unwrap(),
            TarotKind::Devil => render!(translations, path, 1, "Gold Card").unwrap(),
            TarotKind::Tower => render!(translations, path, 1, "Stone Card").unwrap(),
...
impl Translatable for SpectralKind {
    fn translate(&self, translations: &Translations) -> Translation {
        ...
        match self {
            ...
            SpectralKind::Grim => render!(translations, path, 2).unwrap(),
            SpectralKind::Incantation => render!(translations, path, 4).unwrap(),
            ...
            SpectralKind::Immolate =>  render!(translations, path, 5, 20).unwrap(),
